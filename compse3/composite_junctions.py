...
class SE3CompositeJunction:
    ...
    def build_transforms_iterative_correction(self, full_excess_dynamic_coordinates: np.ndarray) -> np.ndarray:
        ...
        corrected_excess_coordinates = g2X(so3.se3_inverse(list_accu_static_comp[0] @ self.tail_static_junction) @ so3.se3_inverse(self.pose1) @ self.pose2 @ so3.se3_inverse(self.tail_static_junction))
